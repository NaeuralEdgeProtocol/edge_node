...
class NaeuralReleaseAppPlugin(FastApiWebAppPlugin):
  ...
  def _regenerate_index_html(self):
    ...
    """ 
    last_update = round(self.time() - self.__last_generation_time, 0)
    html_content += f"""
    <body>
        <div class="jumbo">
            ...
            <p>This page was proudly generated by Edge Node <code>{self.ee_id}:{self.ee_addr} about {last_update}s ago</code>.</p>
